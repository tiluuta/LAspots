...
$adminfrontpage = '
    <html>
        ...
        <body>
            ...
            <div class="navbar">
                <a href="admin-frontpage.html" class="logo">&nbsp;</a>
                <a href="search-spots-admin.php">Search </a>
            ...
            <div class="row">
                ...
                <div class="item" style="width:65%;">
                    ...
                    <br>
                    <div>
                        <button class="green round-button"><a href="random-spots.php">Im feeling lucky</a></button>
                    </div>
